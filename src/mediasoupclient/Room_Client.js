...
//
 ...
 let device,
  ...
  sendCamera = false,
  stopStreams = false,
  localScreenPauseCtrl = false,
  localScreenAudioPauseCtrl = false;
 ...
 export class RoomClient {
  ...
  async updatePeersDisplay(peersInfo = lastPollSyncData,
  ...
  makeTrackControlEl(peerName, mediaTag, mediaInfo) {
  ...
  makeProducerTrackSelector({ internalTag, container, peerId, producerId,
